      ...
      <div className=" bg-yellow-400 h-full flex flex-col gap-8 items-center justify-between p-10 sm:p-7">
        ...
        <div className=" flex items-center justify-center gap-8 sm:gap-5">
          ...
          data-aos="fade-up" data-aos-duration="1000"
            ...
            href="https://t.me/share/url?url=YOUR_URL&text=YOUR_MESSAGE"
          ...
          data-aos="fade-up" data-aos-duration="1200"
            ...
            href="https://wa.me/?text=Check%20out%20my%20portfolio%3A%20https%3A%2F%2Fwww.myportfolio.com"
            className="box font-medium text-white  flex items-center justify-center flex-col"
          >
          ...
          data-aos="fade-up" data-aos-duration="1400"
            ...
            href="https://www.instagram.com/yasharma_31"
            className="box font-medium text-white  flex items-center justify-center flex-col"
          >
